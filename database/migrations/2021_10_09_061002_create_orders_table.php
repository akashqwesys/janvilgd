...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string('payment_mode_name',30);
            $table->foreignId('refTransaction_id');
            $table->foreignId('refCustomer_company_id_billing');
            $table->string('billing_company_name',30);
            $table->string('billing_company_office_no',15);
            $table->string('billing_company_office_email',15);
            $table->text('billing_company_office_address');
            ...
            $table->string('shipping_company_name',30);            
            $table->string('shipping_company_office_no',15);
            $table->string('shipping_company_office_email',15);
            $table->text('shipping_company_office_address');
            ...
            $table->string('delivery_charge_name',30);
            $table->string('delivery_charge_amount',30);
            $table->foreignId('refDiscount_id');
             $table->string('discount_name',30);
            $table->string('discount_amount',30);
            $table->foreignId('refTax_id');
             $table->string('tax_name',30);
            $table->string('tax_amount',30);
            $table->string('total_paid_amount',30);
