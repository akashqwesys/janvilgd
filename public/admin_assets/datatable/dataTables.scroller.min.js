...
(function(c) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(f) { return c(f, window, document) }) : "object" === typeof exports ? module.exports = function(f, g) {
        f || (f = window);
    ...
    c.extend(m.prototype, {
        ...
        construct: function() {
            ...
            if (this.s.dt.oFeatures.bPaginate) {
                ...
                c(this.dom.scroller).on("mousedown.dt-scroller", function() { a.s.mousedown = !0 }).on("mouseup.dt-scroller", function() {
                    a.s.labelVisible = !1;
                    a.s.mousedown = !1;
                ...
                if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;
                    ...
                    if (this.s.forceReposition || d < this.s.redrawTop || d > this.s.redrawBottom) {
                        ...
                        e != this.s.dt._iDisplayStart && (this.s.tableTop = c(this.s.dt.nTable).offset().top, this.s.tableBottom = c(this.s.dt.nTable).height() + this.s.tableTop, e = function() {
                            ...
                            }, this.s.dt.oFeatures.bServerSide ? (this.s.forceReposition = !0, clearTimeout(this.s.drawTO), this.s.drawTO = setTimeout(e, this.s.serverWait)) : e(), this.dom.loader && !this.s.loaderVisible &&
    ...
    m.defaults = { boundaryScale: .5, displayBuffer: 500, loadingIndicator: !1, rowHeight: "auto", serverWait: 1000 };
    ...
    q.register("row().scrollTo()", function(a) {
        var b = this;
        this.iterator("row", function(d, e) { d.oScroller && (e = b.rows({ order: "applied", search: "applied" }).indexes().indexOf(e), d.oScroller.scrollToRow(e, a)) });
        return this
    });
