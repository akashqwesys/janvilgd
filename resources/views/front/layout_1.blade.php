...
<body>
		...
		<nav class="navbar navbar-expand-lg">
		  <div class="container">
			...
			//<![CDATA[
				...
				<img src="assets/images/logo.png" class="img-fluid" data-pagespeed-url-hash="2992076708" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
			</a>
	...
	<div class="live-chat">
		<button class="live-chat-btn" onclick="openForm()">
			<img src="assets/images/chat_conversation.svg" alt="chat-icon" class="chat-icon img-fluid" data-pagespeed-url-hash="3013474078" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
		</button>

		<div class="chat-popup" id="myForm">
			<div class="chat-header">
				<a href="index"><img src="assets/images/logo.png" class="img-fluid" alt="logo" data-pagespeed-url-hash="2992076708" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></a>
				<button type="button" class="btn cancel" onclick="closeForm()"><img src="assets/images/close.svg" alt="close" class="img-fluid" data-pagespeed-url-hash="1261900648" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></button>
			</div>
			<div class="chat-body">
