            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                          <h3 class="nk-block-title page-title" style="display: inline;">Edit State</h3>
                        <a style="float: right;" href="/admin/state" class="btn btn-icon btn-primary">&nbsp;&nbsp;Back To List<em class="icon ni ni-plus"></em></a>
                    ...
                    <div class="card">
                        <div class="card-inner">
                            <form method="POST" action="{{route('state.update')}}">
                                @csrf
                                <input type="hidden" name="id" value="{{ $data['result']->state_id }}">
