                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-2 offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">                                                
                                                <input type="checkbox" name="access_permission[]" value="<?php echo $row->module_id; ?>" > <?php echo $row->name; ?>                                                                                                                                           
                                            </div>
                                 ...
                                 <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-2 offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">                                                
                                                <input type="checkbox" name="modify_permission[]" value="<?php echo $row->module_id; ?>"> <?php echo $row->name; ?>                                                                                                                                              
                                            </div>
