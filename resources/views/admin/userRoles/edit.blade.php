                                    ...
                                    <div class="col-lg-3 offset-1">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <?php
                                                $access_permission = json_decode($data['result']->access_permission);
                                    ...
                                    <div class="col-lg-3 offset-1">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <?php
                                                $modify_permission = json_decode($data['result']->modify_permission);
                                                foreach ($modify_permission as $modify_row) {
                                                    echo set_cheked($row->module_id, $modify_row);
                                                } ?>>
