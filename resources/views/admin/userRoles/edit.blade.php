                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Edit User Role</h3>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-inner">                           
                            <form method="POST" action="{{route('user-role.update')}}">
                                @csrf
                                <input type="hidden" name="id" value="<?php echo $data['result']->user_role_id; ?>">
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-2 offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">                                                
                                                <input type="checkbox" name="access_permission[]" value="<?php echo $row->module_id; ?>" <?php foreach (json_decode($data['result']->access_permission) as $access_row) {echo set_cheked($row->module_id, $access_row);} ?>> <?php echo $row->name; ?>                                                                                                                                              
                                            </div>
                                 ...
                                 <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-2 offset-2">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">                                                
                                                <input type="checkbox" name="modify_permission[]" value="<?php echo $row->module_id; ?>" <?php foreach (json_decode($data['result']->modify_permission) as $modify_row) {echo set_cheked($row->module_id, $modify_row);} ?>> <?php echo $row->name; ?>                                                                                                                                             
                                            </div>
