                        ...
                        <div class="nk-block-head">                                            
                            <div class="nk-block-head-content">                                                
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <h4 style="display: inline;" class="nk-block-title">User Role list</h4>
                                    <a style="float: right;" href="{{route('user-role.add')}}" class="btn btn-icon btn-primary">&nbsp;&nbsp;Add User Role<em class="icon ni ni-plus"></em></a>
                                </div>
