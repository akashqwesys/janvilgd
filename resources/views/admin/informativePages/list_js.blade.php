<?php if ($data['title'] == 'List-Informative-Pages') {
    ?>
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#table').DataTable({
                ...
                ajax: "{{ route('informative-pages.list') }}",
                columns: [                    
...
//                    {data: 'is_deleted', name: 'is_deleted',className: "is_deleted"},
                ...
                "createdRow": function (row, data, dataIndex) {                    
                    $(row).addClass('tr_'+data['informative_page_id']);                      
                }
            });
        });
    </script>
        ...
        $(document).ready(function () {
            $(document).on('click', '.delete_button', function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('informative-pages.delete') }}",
                    data: data,
