            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                             <h3 class="nk-block-title page-title" style="display: inline;">Edit Modules</h3>
                    ...
                    <div class="card">
                        <div class="card-inner">
                            <form method="POST" action="{{route('modules.update')}}">
                                @csrf
                                <input type="hidden" name="id" value="{{ $data['result']->module_id }}">
                                ...
                                <div class="row g-3 align-center">
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <select class="form-select form-control" id="parent_id" name="parent_id" required="" tabindex="-1" aria-hidden="true" data-search="on">
                                                    ...
                                                    @endphp
                                                    <option value="{{ $row->module_id }}" {{ set_selected($row->module_id,$data['result']->parent_id) }}>{{ $row->name . $heading }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                  ...
                                  <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="sort_order" id="sort_order" placeholder="Enter sort value" required="" autocomplete="off" value="{{ $data['result']->sort_order }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
