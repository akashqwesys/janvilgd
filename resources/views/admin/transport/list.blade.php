                        ...
                        <div class="nk-block-head">                                            
                            <div class="nk-block-head-content">                                                
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <h4 style="display: inline;" class="nk-block-title">Transport list</h4>
                                    <a style="float: right;" href="{{route('transport.add')}}" class="btn btn-icon btn-primary">&nbsp;&nbsp;Add transport<em class="icon ni ni-plus"></em></a>
                                </div>
