            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        ...
                        <h3 class="nk-block-title page-title" style="display: inline;">Add City</h3>
                        <a style="float: right;" href="/admin/city" class="btn btn-icon btn-primary">&nbsp;&nbsp;Back To List<em class="icon ni ni-plus"></em></a>
                                                    ...
                                                    <option value="" disabled="" selected="">------ Select State ------</option>
                                                     <?php if(!empty($data['state'])){
                                                        foreach ($data['state'] as $row){
                                                            ?>
                                                            <option value="{{ $row->state_id }}">{{ $row->name }} - {{ $row->country_name }}</option>
                                                    <?php
                                                        }
                                                    } ?>
                                                </select>
