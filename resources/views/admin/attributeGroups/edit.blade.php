                    ...
                    <div class="card">
                        <div class="card-inner">                           
                            <form method="POST" action="{{route('attribute-groups.update')}}">
                                @csrf
                                <input type="hidden" name="id" value="<?php echo $data['result']->attribute_group_id; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">                                                                                                  
                                                <select class="form-select form-control" id="image_required" name="image_required" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                    ...
                                                    <option value="1" <?php echo set_selected(1,$data['result']->image_required); ?>>YES</option> 
                                                    <option value="0" <?php echo set_selected(0,$data['result']->image_required); ?>>No</option> 
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-3 align-center">
                                    <div class="col-md-11 offset-1">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" data-msg="Required" class="custom-control-input required" name="is_required" id="is_required" required value="1" <?php echo set_cheked(1, $data['result']->is_required) ?>>
