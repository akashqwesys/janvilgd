                            ...
                            <form method="POST" action="{{route('diamonds.update')}}" enctype="multipart/form-data">
                                ...
                                <div class="row g-3 align-center d-none" id="barcode">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="barcode" id="barcode" placeholder="Enter barcode" required="" autocomplete="off" value="<?php echo $data['result']->barcode; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center d-none" id="packate_no">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="packate_no" id="packate_no" placeholder="Enter packate no" required="" autocomplete="off" value="<?php echo $data['result']->packate_no; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center d-none" id="actual_pcs">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="actual_pcs" id="actual_pcs" placeholder="Enter actual pcs" required="" autocomplete="off" value="<?php echo $data['result']->actual_pcs; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center d-none" id="available_pcs">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="available_pcs" id="available_pcs" placeholder="Enter available pcs" required="" autocomplete="off" value="<?php echo $data['result']->available_pcs; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center d-none" id="makable_cts">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="makable_cts" id="makable_cts" placeholder="Enter makable cts" required="" autocomplete="off" value="<?php echo $data['result']->makable_cts; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center d-none" id="expected_polish_cts">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="expected_polish_cts" id="expected_polish_cts" placeholder="Enter expected polish cts" required="" autocomplete="off" value="<?php echo $data['result']->expected_polish_cts; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center d-none" id="remarks">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="remarks" id="remarks" placeholder="Enter remarks" required="" autocomplete="off" value="<?php echo $data['result']->remarks; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 align-center d-none" id="rapaport_price">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="rapaport_price" id="rapaport_price" placeholder="Enter rapaport price" required="" autocomplete="off" value="<?php echo $data['result']->rapaport_price; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center d-none" id="discount">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="discount" id="discount" placeholder="Enter discount" required="" autocomplete="off" value="<?php echo $data['result']->discount; ?>">                                              
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center d-none" id="weight_loss">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="weight_loss" id="weight_loss" placeholder="Enter weight loss" required="" autocomplete="off" value="<?php echo $data['result']->weight_loss; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center d-none " id="video_link">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="url" class="form-control" name="video_link" id="video_link" placeholder="Enter video link" required="" autocomplete="off" value="<?php echo $data['result']->video_link; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>                            
