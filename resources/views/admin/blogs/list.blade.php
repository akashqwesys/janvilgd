                        ...
                        <div class="nk-block-head">                                            
                            <div class="nk-block-head-content">                                                
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <h4 style="display: inline;" class="nk-block-title">Blog list</h4>
                                    <a style="float: right;" href="{{route('blogs.add')}}" class="btn btn-icon btn-primary">&nbsp;&nbsp;Add Blog<em class="icon ni ni-plus"></em></a>
                                </div>
