            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                            <h3 class="nk-block-title page-title" style="display: inline;">Add Blog</h3>
                ...
                <div class="nk-block nk-block-lg">
                    <div class="card">
                        <div class="card-inner">
                            <form method="POST" action="{{route('blogs.save')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <textarea id="summernote-basic-id" name="description"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
