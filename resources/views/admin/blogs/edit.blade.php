            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                              <h3 class="nk-block-title page-title" style="display: inline;">Edit Blog</h3>
                        <a style="float: right;" href="/admin/blogs" class="btn btn-icon btn-primary">&nbsp;&nbsp;Back To List<em class="icon ni ni-plus"></em></a>
                    ...
                    <div class="card">
                        <div class="card-inner">
                            <form method="POST" action="{{route('blogs.update')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $data['result']->blog_id }}">
                                ...
                                if (!empty($data['result']->image)) {
                                    ...
                                    if (!empty($image)) {
                                        ...
                                        foreach ($image as $img_row) {
                                            ?>
                                                <div class="col-lg-2" id="img_<?php echo $data['result']->blog_id.'_'.$i; ?>">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <div class="removeimg">
                                                                <img src="/storage/other_images/{{ $img_row }}"/>
                                                                <span class="btn btn-xs btn-danger delete_img_button" data-id="<?php echo $data['result']->blog_id; ?>" data-inc="<?php echo $i; ?>" data-image="<?php echo $img_row; ?>" data-table="blogs" data-wherefield="blog_id"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
