                    ...
                    <div class="card">
                        <div class="card-inner">
                            <form method="POST" action="{{route('blogs.update')}}" enctype="multipart/form-data">
                                ...
                                <div class="row g-3 align-center" id="img_{{ $data['result']->blog_id }}">
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            &nbsp;
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <div class="removeimg">
                                                    ...
                                                    <span class="btn btn-xs btn-danger delete_img_button" data-id="{{ $data['result']->blog_id }}" data-image="{{ $data['result']->image }}" data-table="blogs" data-wherefield="blog_id"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
