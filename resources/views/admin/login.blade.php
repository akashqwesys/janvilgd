                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the Janvi LGD Pvt Ltd panel using your email and passcode.</p>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <ul class="language-list">
                                                    <li>
                                                        <a href="#" class="language-item">
                                                            <img src="{{ asset(check_host().'admin_assets/images/flags/english.png')}}" alt="" class="language-flag">
                                                            <span class="language-name">English</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" class="language-item">
                                                            <img src="{{ asset(check_host().'admin_assets/images/flags/spanish.png')}}" alt="" class="language-flag">
                                                            <span class="language-name">Español</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" class="language-item">
                                                            <img src="{{ asset(check_host().'admin_assets/images/flags/french.png')}}" alt="" class="language-flag">
                                                            <span class="language-name">Français</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" class="language-item">
                                                            <img src="{{ asset(check_host().'admin_assets/images/flags/turkey.png')}}" alt="" class="language-flag">
