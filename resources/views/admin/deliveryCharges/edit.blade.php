                    ...
                    <div class="card">
                        <div class="card-inner">                           
                            <form method="POST" action="{{route('delivery-charges.update')}}">
                                @csrf
                                <input type="hidden" name="id" value="<?php echo $data['result']->delivery_charge_id; ?>">                                
                                                    ...
                                                    <option value="" disabled="" selected="">------ Select State ------</option> 
                                                     <?php if(!empty($data['transport'])){
                                                        foreach ($data['transport'] as $row){
                                                            ?>
                                                            <option value="<?php echo $row->transport_id.'_'.$row->name; ?>" <?php echo set_selected($row->transport_id,$data['result']->reftransport_id); ?>><?php echo $row->name; ?></option>
                                                    <?php
                                                        }
                                                    } ?>
                                                </select>
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="from_weight" id="from_weight" placeholder="Enter from weight" required="" autocomplete="off" value="<?php echo $data['result']->from_weight; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="to_weight" id="to_weight" placeholder="Enter to weight" required="" autocomplete="off" value="<?php echo $data['result']->to_weight; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="amount" id="amount" placeholder="Enter amount" required="" autocomplete="off" value="<?php echo $data['result']->amount; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>                           
