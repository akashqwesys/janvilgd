                    ...
                    <div class="card">
                        <div class="card-inner">                            
                            <form  method="POST" action="{{route('customers.update')}}" enctype="multipart/form-data" class="nk-wizard nk-wizard-simple is-alter">
                                @csrf
                                <input type="hidden" name="id" value="<?php echo $data['result']->customer_id; ?>">
                                ...
                                <div class="nk-wizard-content">
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Enter mobile number" autocomplete="off"  value="<?php echo $data['result']->mobile; ?>">                                             
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="email" class="form-control" name="email" id="email" placeholder="Enter email" autocomplete="off"  value="<?php echo $data['result']->email; ?>">                                                 
                                                    @if($errors->has('email'))
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">                                            
                                                <div class="form-control-wrap">
                                                    <textarea name="address" class="form-control form-control-sm" id="cf-default-textarea" placeholder="Enter address"> <?php echo $data['result']->address; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="pincode" id="pincode" placeholder="Enter pincode" autocomplete="off"  value="<?php echo $data['result']->pincode; ?>">                                             
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <select class="form-control" id="refCountry_id" name="refCountry_id" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                        ...
                                                        if (!empty($data['country'])) {
                                                            foreach ($data['country'] as $row) {
                                                                ?>
                                                                <option value="<?php echo $row->country_id; ?>" <?php echo set_selected($row->country_id,$data['result']->refCountry_id); ?>><?php echo $row->name; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                    ...
                                                    <select class="form-control" id="refState_id" name="refState_id" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                        ...
                                                        if (!empty($data['state'])) {
                                                            foreach ($data['state'] as $row) {
                                                                ?>
                                                                <option value="<?php echo $row->state_id; ?>" <?php echo set_selected($row->state_id,$data['result']->refState_id); ?>><?php echo $row->name; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                    ...
                                                    <select class="form-control" id="refCity_id" name="refCity_id" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                        ...
                                                        if (!empty($data['city'])) {
                                                            foreach ($data['city'] as $row) {
                                                                ?>
                                                                <option value="<?php echo $row->city_id; ?>" <?php echo set_selected($row->city_id,$data['result']->refCity_id); ?>><?php echo $row->name; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                    ...
                                                    <select class="form-control" id="refCustomerType_id" name="refCustomerType_id" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                        ...
                                                        if (!empty($data['customer_type'])) {
                                                            foreach ($data['customer_type'] as $row) {
                                                                ?>
                                                                <option value="<?php echo $row->customer_type_id; ?>" <?php echo set_selected($row->customer_type_id,$data['result']->refCustomerType_id); ?>><?php echo $row->name; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-wrap">                                                                                                  
                                                    <select class="form-control" id="restrict_transactions" name="restrict_transactions" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                        <option value="1" <?php echo set_selected(1,$data['result']->restrict_transactions); ?>>YES</option>
                                                        <option value="0" <?php echo set_selected(0,$data['result']->restrict_transactions); ?>>No</option>                                                  
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="nk-wizard-content">
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="company_name" id="company_name" placeholder="Enter name" required="" autocomplete="off" value="<?php echo $data['result2']->name; ?>">                                              
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="office_no" id="office_no" placeholder="Enter mobile number" autocomplete="off" value="<?php echo $data['result2']->office_no; ?>">                                             
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="email" class="form-control" name="official_email" id="official_email" placeholder="Enter email" autocomplete="off" value="<?php echo $data['result2']->official_email; ?>">                                                 
                                                    @if($errors->has('email'))
                                                    ...
                                                    <select class="form-control" id="designation_id" name="designation_id" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                        ...
                                                        if (!empty($data['designation'])) {
                                                            foreach ($data['designation'] as $row) {
                                                                ?>
                                                                <option value="<?php echo $row->id; ?>" <?php echo set_selected($row->id,$data['result2']->refDesignation_id); ?>><?php echo $row->name; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">                                            
                                                <div class="form-control-wrap">
                                                    <textarea name="office_address" class="form-control form-control-sm" id="office_address" placeholder="Enter address"><?php echo $data['result2']->office_address; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="office_pincode" id="office_pincode" placeholder="Enter pincode" autocomplete="off" value="<?php echo $data['result2']->pincode; ?>">                                             
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-control-wrap">                                                                                                  
                                                    <select class="form-control" id="office_country_id" name="office_country_id" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                        ...
                                                        if (!empty($data['country'])) {
                                                            foreach ($data['country'] as $row) {
                                                                ?>
                                                                <option value="<?php echo $row->country_id; ?>" <?php echo set_selected($row->country_id,$data['result2']->refCountry_id); ?>><?php echo $row->name; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-control-wrap">                                                                                                  
                                                    <select class="form-control" id="office_state_id" name="office_state_id" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                        ...
                                                        if (!empty($data['state'])) {
                                                            foreach ($data['state'] as $row) {
                                                                ?>
                                                                <option value="<?php echo $row->state_id; ?>" <?php echo set_selected($row->state_id,$data['result2']->refState_id); ?>><?php echo $row->name; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-control-wrap">                                                                                                  
                                                    <select class="form-control" id="office_city_id" name="office_city_id" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                        ...
                                                        if (!empty($data['city'])) {
                                                            foreach ($data['city'] as $row) {
                                                                ?>
                                                                <option value="<?php echo $row->city_id; ?>" <?php echo set_selected($row->city_id,$data['result2']->refCity_id); ?>><?php echo $row->name; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="pan_gst_no" id="pan_gst_no" placeholder="Enter pan or gst no" autocomplete="off" value="<?php echo $data['result2']->pan_gst_no; ?>">                                             
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-11 offset-1">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" data-msg="Required" class="custom-control-input required" name="is_approved" id="is_approved" required value="1" <?php echo set_cheked(1, $data['result2']->is_approved) ?>>
