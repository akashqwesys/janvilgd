        ...
        $(document).ready(function () {           
            var table = $('#table').DataTable({
                ...
                columns: [                    
                    ...
                    {data: 'id_proof_1', name: 'id_proof_1'},
                    {data: 'id_proof_2', name: 'id_proof_2'},                    
                    {data: 'role_id', name: 'role_id'},
                    {data: 'username', name: 'username'},
                    {data: 'added_by', name: 'added_by'},
                    {data: 'last_login_type', name: 'last_login_type'},
                    {data: 'last_login_date_time', name: 'last_login_date_time'},
