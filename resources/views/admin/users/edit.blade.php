                            ...
                            <form method="POST" action="{{route('users.update')}}" enctype="multipart/form-data">
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="mobile" maxlength="10" minlength="10" id="mobile" placeholder="Enter mobile number" autocomplete="off" value="<?php echo $data['result']->mobile; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <option value="">------ Select Country ------</option> 
                                                     <?php if(!empty($data['country'])){
                                                        foreach ($data['country'] as $row){
                                                            ?>
                                                            <option value="<?php echo $row->country_id; ?>" <?php echo set_selected($row->country_id,$data['result']->country_id); ?>><?php echo $row->name; ?></option>
                                                    <?php
                                                        }
                                                    } ?>
                                                </select>
                                                    ...
                                                    <option value="">------ Select State ------</option> 
                                                     <?php if(!empty($data['state'])){
                                                        foreach ($data['state'] as $row){
                                                            ?>
                                                            <option value="<?php echo $row->state_id; ?>" <?php echo set_selected($row->state_id,$data['result']->state_id); ?>><?php echo $row->name; ?></option>
                                                    <?php
                                                        }
                                                    } ?>
                                                </select>
                                                    ...
                                                    <option value="">------ Select City ------</option> 
                                                     <?php if(!empty($data['city'])){
                                                        foreach ($data['city'] as $row){
                                                            ?>
                                                            <option value="<?php echo $row->city_id; ?>" <?php echo set_selected($row->city_id,$data['result']->city_id); ?>><?php echo $row->name; ?></option>
                                                    <?php
                                                        }
                                                    } ?>
                                                </select>
                                                    ...
                                                    <option value="">------ Select Role ------</option> 
                                                     <?php if(!empty($data['user_role'])){
                                                        foreach ($data['user_role'] as $row){
                                                            ?>
                                                            <option value="<?php echo $row->user_role_id; ?>" <?php echo set_selected($row->user_role_id,$data['result']->role_id); ?>><?php echo $row->name; ?></option>
                                                    <?php
                                                        }
                                                    } ?>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">                                                                                                  
                                                <select class="form-select form-control" id="user_type" name="user_type" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                   ...
                                                   <option value="MASTER_ADMIN" <?php echo set_selected('MASTER_ADMIN',$data['result']->user_type); ?>>MASTER ADMIN</option> 
                                                   <option value="USER" <?php echo set_selected('USER',$data['result']->user_type); ?>>USER</option> 
                                                </select>
                                            </div>
                                        </div>
                                    </div>
