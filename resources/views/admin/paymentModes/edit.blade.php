                    ...
                    <div class="card">
                        <div class="card-inner">                           
                            <form method="POST" action="{{route('payment-modes.update')}}">
                                @csrf
                                <input type="hidden" name="id" value="<?php echo $data['result']->payment_mode_id; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">                                                                                                  
                                                <select class="form-select form-control" id="sort_order" name="sort_order" required="" tabindex="-1" aria-hidden="true" data-search="on">                                                    
                                                    <option value="ASC" <?php echo set_selected("ASC",$data['result']->sort_order); ?>>Ascending</option>      
                                                    <option value="DESC" <?php echo set_selected("DESC",$data['result']->sort_order); ?>>Descending</option>                                                         
                                                </select>
                                            </div>
                                        </div>
                                    </div>
