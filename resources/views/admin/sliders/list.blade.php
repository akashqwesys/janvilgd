                        ...
                        <div class="nk-block-head">                                            
                            <div class="nk-block-head-content">                                                
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <h4 style="display: inline;" class="nk-block-title">Slider list</h4>
                                    <a style="float: right;" href="{{route('sliders.add')}}" class="btn btn-icon btn-primary">&nbsp;&nbsp;Add slider<em class="icon ni ni-plus"></em></a>
                                </div>
