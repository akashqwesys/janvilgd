                        ...
                        <div class="nk-block-head">                                            
                            <div class="nk-block-head-content">                                                
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <h4 style="display: inline;" class="nk-block-title">Rapaport CSV Type list</h4>
                                    <a style="float: right;" href="{{route('rapaport.import_excel')}}" class="btn btn-icon btn-primary">&nbsp;&nbsp;Import Excel<em class="icon ni ni-plus"></em></a>
                                    <a style="float: right;margin-right: 5px;" href="{{route('rapaport.add')}}" class="btn btn-icon btn-primary">&nbsp;&nbsp;Add CSV Type<em class="icon ni ni-plus"></em></a>
                                </div>
