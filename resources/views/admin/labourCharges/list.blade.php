                        ...
                        <div class="nk-block-head">                                            
                            <div class="nk-block-head-content">                                                
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <h4 style="display: inline;" class="nk-block-title">Labour Charges List</h4>
                                    <a style="float: right;" href="{{route('labour-charges.add')}}" class="btn btn-icon btn-primary">&nbsp;&nbsp;Add labour charges<em class="icon ni ni-plus"></em></a>
                                </div>
