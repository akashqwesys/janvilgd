                    ...
                    <div class="card">
                        <div class="card-inner">                           
                            <form method="POST" action="{{route('designation.update')}}">
                                @csrf
                                <input type="hidden" name="id" value="<?php echo $data['designation']->id; ?>">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter designation name" required="" autocomplete="off" value="<?php echo $data['designation']->name; ?>">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
