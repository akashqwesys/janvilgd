            ...
            <div class="nk-content-body">   
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                            ...
                            <h3 class="nk-block-title page-title" style="display: inline;">Add Designation</h3>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" name="name" id="name" placeholder="Enter designation name" required="" autocomplete="off">                                             
                                        </div>
                                    </div>
                                </div>
                            </div>
