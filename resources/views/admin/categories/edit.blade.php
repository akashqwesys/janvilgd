                    ...
                    <div class="card">
                        <div class="card-inner">                           
                            <form method="POST" action="{{route('categories.update')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="<?php echo $data['result']->category_id; ?>">
                                ...
                                <div class="row g-3 align-center" id="img_<?php echo $data['result']->category_id; ?>">
                                    <div class="col-lg-2">
                                        <div class="form-group">                                            
                                            &nbsp;
                                        </div>
                                        ...
                                        <div class="form-group">                                           
                                            <div class="form-control-wrap">
                                                <div class="removeimg">
                                                    ...
                                                    <span class="btn btn-xs btn-danger delete_img_button" data-id="<?php echo $data['result']->category_id; ?>" data-image="<?php echo $data['result']->image; ?>" data-table="categories" data-wherefield="category_id"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>                                    
