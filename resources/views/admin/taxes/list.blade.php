                        ...
                        <div class="nk-block-head">                                            
                            <div class="nk-block-head-content">                                                
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <h4 style="display: inline;" class="nk-block-title">Taxes list</h4>
                                    <a style="float: right;" href="{{route('taxes.add')}}" class="btn btn-icon btn-primary">&nbsp;&nbsp;Add Tax<em class="icon ni ni-plus"></em></a>
                                </div>
