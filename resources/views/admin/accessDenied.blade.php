...
<head>
    ...
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="/admin_assets/assets/css/dashlite.css?ver=1.9.2">
    <link id="skin-default" rel="stylesheet" href="/admin_assets/assets/css/theme.css?ver=1.9.2">
    <style>
        .wide-xs {
...
<body class="nk-body bg-white npc-default pg-error">
                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle wide-xs mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            ...
                            <a href="{{ url()->previous() }}" class="btn btn-lg btn-primary mt-2">Back To Previous Page</a>
                            <a href="/admin/logout" class="btn btn-lg btn-primary mt-2">Logout</a>
                        </div>
                    </div><!-- .nk-block -->
                </div>
                <!-- wrap @e -->
    ...
    <!-- app-root @e -->
    <!-- JavaScript -->
    <script src="admin_assets/assets/js/bundle.js?ver=1.9.2"></script>
    <script src="admin_assets/assets/js/scripts.js?ver=1.9.2"></script>
