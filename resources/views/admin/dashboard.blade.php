                            ...
                            <div class="card h-100">
                                <div class="card-inner">
                                    ...
                                    <ul class="nk-top-products">
                                        <li class="item">
                                            <div class="thumb">
                                                <img src="{{ asset(check_host().'admin_assets/images/product/a.png') }}" alt="">
                                            </div>
                                            <div class="info">
                                        ...
                                        <li class="item">
                                            <div class="thumb">
                                                <img src="{{ asset(check_host().'admin_assets/images/product/b.png') }}" alt="">
                                            </div>
                                            <div class="info">
                                        ...
                                        <li class="item">
                                            <div class="thumb">
                                                <img src="{{ asset(check_host().'admin_assets/images/product/c.png') }}" alt="">
                                            </div>
                                            <div class="info">
                                        ...
                                        <li class="item">
                                            <div class="thumb">
                                                <img src="{{ asset(check_host().'admin_assets/images/product/d.png') }}" alt="">
                                            </div>
                                            <div class="info">
                                        ...
                                        <li class="item">
                                            <div class="thumb">
                                                <img src="{{ asset(check_host().'admin_assets/images/product/e.png') }}" alt="">
                                            </div>
                                            <div class="info">
