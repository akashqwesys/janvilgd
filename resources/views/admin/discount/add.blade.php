            ...
            <div class="nk-content-body">   
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                              ...
                              <h3 class="nk-block-title page-title" style="display: inline;">Add Discount</h3>
                            ...
                            <form method="POST" action="{{route('discount.save')}}">
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name='from_amount' id="from_amount" placeholder="Enter from amount" autocomplete="off">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" name='to_amount' id="to_amount" placeholder="Enter to amount" autocomplete="off">                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>                                                                
